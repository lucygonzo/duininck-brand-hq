...
export const OPEN_PRIORITIES = [
  ...
  { text: 'Evaluate intranet solutions for 700+ disconnected field employees', urgency: 'High', owner: 'Nicole' },
  { text: 'Map seasonal content calendar: what to shoot, when, where, why', urgency: 'High', owner: 'Lucy + Nicole' },
];
